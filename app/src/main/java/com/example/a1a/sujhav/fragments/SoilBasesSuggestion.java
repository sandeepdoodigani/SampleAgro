...
import com.example.a1a.sujhav.login_fragments.SignUp_Fragment;
...
public class SoilBasesSuggestion extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View v = inflater.inflate(R.layout.fragment_soil_bases_suggestion, container, false);
        ...
        getSuggestion = (Button) v.findViewById(R.id.getSuggestion);
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        getActivity().setTitle("SoilSuggestion");
    }
    ...
    class sendData extends AsyncTask<Void, Void, String> {
        ...
        protected String doInBackground(Void... urls) {
            try {
                URL url = new URL("http://www.sujhav.in/API/soil_information");
